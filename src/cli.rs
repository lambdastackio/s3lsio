...
pub fn build_cli<'a>(app: &str, home: &'a str, version: &'a str) -> App<'a, 'a> {
  App::new(app)
   ...
   .subcommand(SubCommand::with_name("bucket")
      .about("Admin Bucket Options: s3lsio -a bucket <command> s3://<bucket> <user> <stats> <fix> <check>")
   ...
   .subcommand(SubCommand::with_name("quota")
      .about("Admin Quota Options: s3lsio -a quota <user> <command> <action> <size> <count>")
      .arg_from_usage("[user] 'User ID (uid)'")
   ...
   .subcommand(SubCommand::with_name("cap")
      .about("Admin Caps Admin User: s3lsio -a cap <user> <caps>")
      .arg_from_usage("[user] 'User ID (uid)'")
      .arg_from_usage("[caps] 'Admin Capability of user'"))
   .subcommand(SubCommand::with_name("user")
      .about("Admin User Options: s3lsio -a user <commands> [options]")
   ...
   .subcommand(SubCommand::with_name("usage")
      .about("Admin Usage Options: s3lsio -a usage ls <user> <start> <end> <show_entries> <show_summary>")
      .subcommand(SubCommand::with_name("ls")
   ...
   .subcommand(SubCommand::with_name("keys")
      .about("Admin Keys Options: s3lsio -a keys <command> [options]")
      .subcommand(SubCommand::with_name("create")
